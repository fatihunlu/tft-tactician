...
export const SET17_COMPS: Comp[] = [
  ...
  },
  {
    ...
    notes: [
      ...
      "Itemize Ezreal first; Pantheon soaks with cheap tank components.",
  ...
  },
  {
    ...
    summary:
      "Early Dark Star board; cheap frontline plus one AP threat before committing to four-costs.",
    patch: "17.1",
    lastUpdated: "2026-04-12",
    tier: "B",
    difficulty: "easy",
    playstyle: "standard",
    rollInfo: "Standard leveling; pivot to a bigger Dark Star comp if you hit pairs.",
    traits: [
      { name: "Dark Star", count: 2 },
    ...
    notes: [
      "Budget opener — transition into four-cost Dark Star carries when healthy.",
  ...
  },
  {
    ...
    notes: [
      "Not a full commit — use when augments or shop push AP + frontline.",
